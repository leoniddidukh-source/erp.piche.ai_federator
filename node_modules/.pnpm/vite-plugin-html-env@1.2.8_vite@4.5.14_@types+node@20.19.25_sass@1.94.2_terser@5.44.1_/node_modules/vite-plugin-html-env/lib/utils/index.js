...
function removeComments(codes) {
  let _replaceQuotationMark = replaceQuotationMarksWithForwardSlash(codes),
      replacedCodes = _replaceQuotationMark.replacedCodes,
      matchedObj = _replaceQuotationMark.matchedObj;
